...
<p style="font-size: 10px;"><br><button type="submit"><a href="http://localhost:8081/test/shophome.jsp">LOGIN</a></button></p>
<p style="font-size: 10px;"><br><button type="button" class="cancelbtn"><a href="http://localhost:8081/test/home.jsp">Cancel</a></button></p>
<p style="font-size: 10px;"><br><button type="button" class="registerbtn"><a href="shopregistr.html">Register</a></button></p>   
</form>
</body>     
</html> 